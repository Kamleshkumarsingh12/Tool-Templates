        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-r from-[#1D4ED8] to-[#3B82F6] rounded-[28px] px-10 py-12 text-white">
            ...
            <p className="text-[15px] leading-relaxed text-[#E0E7FF] max-w-8xl">
              Understanding your percentage helps in assessing eligibility for global universities, scholarships, and professional programs. It helps students in planning their academics and preparing for career development confidently.
            </p>
